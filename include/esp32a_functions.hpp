...
void thingspeak();
void weathercloud();
void sendToWindy(); // Nombre actualizado y consistente
void pws();
...
void enviardatos()
{
    ...
    // En donde tengas definido el array de servicios
    const ServiceConfig services[] = {
        {"ThingSpeak", &thingspeak_enabled, thingspeak},
        {"Weathercloud", &weathercloud_enabled, weathercloud},
        {"Windy", &windy_enabled, sendToWindy}, // Nombre actualizado aquí
        {"Pwsweather", &pwsweather_enabled, pws}
    };
